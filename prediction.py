# prediction.py - classify irises by genus and species using petal and sepal geometry
...
if repeat_model_validation:
	...
	freqTable.plot(kind='bar',title='Algorithm Comparison') # Which trial is "usually" best?
